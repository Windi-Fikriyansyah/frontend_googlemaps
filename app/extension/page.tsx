      ...
      <div className="flex flex-col md:flex-row gap-6 items-start md:items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-8">
        <div className="space-y-2 max-w-2xl">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400">
            Unduh ekstensi Chrome resmi kami untuk mengotomatiskan alur kerja
            Anda. Install versi ZIP terbaru untuk fungsionalitas penuh.
          </p>
        </div>
      </div>
        ...
        <div className="bg-gradient-to-br from-blue-600 to-indigo-800 rounded-[2.5rem] p-10 text-white shadow-2xl shadow-blue-500/20 flex flex-col justify-between overflow-hidden relative group">
          ...
          <div className="z-10 mb-8">
            ...
            <p className="text-blue-100/80 mb-8 leading-relaxed max-w-md">
              Ekstrak data bisnis dari Google Maps secara otomatis dan ekspor
              langsung ke sistem lead Anda.
            </p>

            <div className="space-y-4">
              {[
                "Auto-Scrape Data",
                "Export to Excel/Leads",
                "Bypass Limitations",
              ].map((feature, i) => (
          ...
          <div className="z-10 mt-6 mt-auto">
            ...
            >
              <a
                href="/extensions/scrapemapswamaps.zip"
                download="extension-scraper-maps.zip"
              >
        ...
        <div className="bg-gradient-to-br from-emerald-500 to-teal-700 rounded-[2.5rem] p-10 text-white shadow-2xl shadow-emerald-500/20 flex flex-col justify-between overflow-hidden relative group">
          ...
          <div className="z-10 mb-8">
            ...
            <p className="text-emerald-50/80 mb-8 leading-relaxed max-w-md">
              Kirim pesan WhatsApp massal secara otomatis dengan aman dan
              efisien langsung dari browser Anda.
            </p>

            <div className="space-y-4">
              {["Anti-Ban Automation", "Kirim Gambar", "Bulk Processing"].map(
                (feature, i) => (
                  <div
                    key={i}
          ...
          <div className="z-10 mt-6 mt-auto">
            ...
            >
              <a
                href="/extensions/extensionwhatsapp.zip"
                download="extension-broadcast-wa.zip"
              >
                <Download className="w-5 h-5 mr-3" />
        ...
        <div className="flex flex-col md:flex-row gap-12">
          <div className="md:w-1/3 space-y-4">
            ...
            <p className="text-slate-600 dark:text-slate-400">
              Ikuti langkah-langkah sederhana di samping untuk mengaktifkan
              ekstensi di Google Chrome Anda.
            </p>
            <div className="p-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800/50 rounded-2xl">
              <p className="text-sm text-blue-700 dark:text-blue-300 font-medium leading-relaxed">
                <b>Note:</b> Pastikan untuk mengekstrak file ZIP terlebih dahulu
            ...
            {[
              {
                step: "1",
                title: "Ekstrak ZIP",
                desc: "Klik kanan file ZIP yang didownload dan pilih 'Extract All' ke folder tujuan.",
              },
              {
                step: "2",
                title: "Buka chrome://extensions",
                desc: "Ketik URL tersebut di address bar Chrome Anda dan tekan Enter.",
              },
              {
                step: "3",
                title: "Aktifkan Developer Mode",
                desc: "Cari switch 'Developer mode' di pojok kanan atas dan nyalakan.",
              },
              {
                step: "4",
                title: "Load Unpacked",
                desc: "Klik tombol 'Load unpacked' dan pilih folder hasil ekstrak tadi.",
              },
            ].map((item, idx) => (
