...
export default function DesktopPage() {
  const downloadLink =
    "https://www.dropbox.com/scl/fi/d0objgz9trpn5nygvwnwx/Wamaps.zip?rlkey=57a2it0g79gzcnd9d0pe6b0qe&st=t055lzsr&dl=0";
  ...
  const features = [
    ...
    },
    {
      ...
      desc: "Scraping lebih leluasa karena dijalankan langsung dari local machine.",
    },
    {
      icon: Shield,
          ...
          <div className="max-w-5xl mx-auto space-y-6 md:space-y-8">
            ...
            <div>
              ...
              <p className="text-slate-500 dark:text-slate-400 font-medium mt-1 text-sm md:text-base">
                Tingkatkan efisiensi lead generation Anda dengan aplikasi native
                desktop Wamaps. Lebih ngebut, lebih aman.
              </p>
            </div>
                  ...
                  <CardContent className="p-10 relative z-10 flex flex-col items-center text-center space-y-6">
                    ...
                    <div className="space-y-2 max-w-md">
                      ...
                      <p className="text-blue-100 font-medium">
                        Download dan jalankan ekstrak filenya di Windows Anda.
                ...
                <Card className="border-none shadow-xl shadow-slate-200/50 dark:shadow-none bg-white dark:bg-slate-900 rounded-[2.5rem] overflow-hidden">
                  <CardContent className="p-8 space-y-6">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 font-medium text-sm">
                      Tonton panduan singkat ini untuk melihat cara instalasi
                      dan penggunaan versi Desktop.
                    </p>
